...
function createNavHardMTT(){
  ...
  ul.appendChild(liLink('../../PushFold/PF-UTG.html','PUSH/FOLD'));
  ul.appendChild(liLink('../../ISO/IsolateUTGMP.html','ISOLATE'));
  ul.appendChild(liLink('../../SQUEEZE/SqueezeSBBBvsUTG.html','SQUEEZE'));
  ul.appendChild(liGray('Defebce BB'));
  ul.appendChild(liLink('../3betPush16-25bb/DefBB3betPUSH1625bbBBvsUTG.html','BB 3bet PUSH 16-25bb'));
